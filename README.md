...
I am Research Scientist (AI) at the **German Research Center for Artificial Intelligence (DFKI)**, Germany. My research focuses on developing advanced machine learning techniques, specifically in structural-temporal analysis, multivariate sequential learning, and longitudinal analysis. I am working on designing robust methods for **Anomaly Detection** and investigating the capabilities of **Large Language Models**, to improve their application across various domains.
